...
# อ่าน Test Set
with open('./bird/data/train/test_split_bird_15.json', 'r', encoding='utf-8') as f:
...
with open('./bird/exp_result/gemma3_test_split_output/th/predict_test.json', 'w', encoding='utf-8') as f:
